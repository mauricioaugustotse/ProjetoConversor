...
# -*- coding: utf-8 -*-
"""
TRF1 PDF -> CSV com enriquecimento OpenAI (modo exclusivo).
...
- Gerar CSV dedicado do pipeline OpenAI.
- Enriquecer colunas analíticas via OpenAI (gpt-5-mini).
...
def setup_logger(verbose: bool, quiet: bool) -> logging.Logger:
    logger = logging.getLogger("trf1_openai")
