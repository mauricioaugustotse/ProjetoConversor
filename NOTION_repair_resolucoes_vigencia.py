...
DEFAULT_IMPORT_CHECKPOINT = Path("resolucoes_rag_consolidado_checkpoint.json")
DEFAULT_REPAIR_CHECKPOINT = Path("resolucoes_rag_vigencia_repair_checkpoint.json")
