...
def _caminho_saida_padrao() -> str:
    # Antes do movimento para conversores/, a pasta do script era a raiz do
    # projeto; mantem-se a saida padrao ancorada na raiz (_PROJECT_ROOT).
    return os.path.join(str(_PROJECT_ROOT), NOME_ARQUIVO_SAIDA)
