...
# Antes do movimento para conversores/, a pasta do script era a raiz do projeto;
# mantemos a ancoragem na raiz para preservar entradas/saidas (arquivos_txt, CSV).
