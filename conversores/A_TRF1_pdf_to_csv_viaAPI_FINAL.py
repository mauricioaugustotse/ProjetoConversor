...
def add_final_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--classe-config-file", default=str(_PROJECT_ROOT / "canon_config" / "classe_canonical.yaml"))

    parser.add_argument("--report-dir", default=str(_PROJECT_ROOT / "reports"))
...
def open_gui_control_panel(args: argparse.Namespace) -> bool:
    ...
    output_dir_default = str(_PROJECT_ROOT)
    mode_default = "auto"
